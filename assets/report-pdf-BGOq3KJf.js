import{c as y}from"./emotion-fusion-B5qwAQEw.js";function k(s,c){const{hr:p,confidence:v,hrv:r,emotion:b}=s,o=r?.metrics,e=r?.stress,d=r?.quality,g=b?.summary||s.emotionSummary||null,i=y(r?{metrics:o,stress:e}:null,g),a=c?new Date(c):new Date,f=`${a.getFullYear()}年${a.getMonth()+1}月${a.getDate()}日`,m=`${String(a.getHours()).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`,x=v>.4?"高":v>.2?"中":"低",n=i.overall.score>=0,h=t=>t<0?"計測不能":t>=70?"低い":t>=45?"やや高め":"高い",u=t=>t<0?"計測不能":t>=70?"十分":t>=45?"普通":"やや不足",$=t=>t<0?"計測不能":t>=70?"良好":t>=45?"普通":"やや乱れ",w=`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8">
