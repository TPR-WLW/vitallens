...
export default function DashboardMock({ onBack }) {
  const maxStress = Math.max(...TEAM_DATA.trend.map((d) => d.stress));
    ...
    <div className="dashboard">
      ...
      <header className="dash-top-header">
        <div className="dash-top-inner">
          ...
          <span className="dash-top-badge">Demo</span>
        </div>
      ...
      <div className="dash-content">
        ...
        <div className="dash-two-col">
          ...
          <div className="dash-panel">
            ...
            <p className="trend-note">77% of check-ins in Relaxed or Normal range.</p>
          </div>
        </div>
